class CommunicationList {
  ...
  static CommunicationList fromJson(json) => CommunicationList(
...
List<CommunicationList> getChatList() {
  const listofChat = [
    {
      'parentName': "Prakash",
      'parentText':
  ...
  return listofChat.map<CommunicationList>(CommunicationList.fromJson).toList();
}
