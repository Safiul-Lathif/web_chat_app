...
class CommunicationListModel {
  ...
  static CommunicationListModel fromJson(json) => CommunicationListModel(
...
List<CommunicationListModel> getAllTheList() {
  var listofData = [
    {
      "name": "Aswin",
  ...
  return listofData
      .map<CommunicationListModel>(CommunicationListModel.fromJson)
      .toList();
}
