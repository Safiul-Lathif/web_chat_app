...
class SujathaSchoolList {
  ...
  static SujathaSchoolList fromJson(json) => SujathaSchoolList(
...
List<SujathaSchoolList> getAllTheList() {
  var listofData = [
    {
      "name": "LKG - A",
  ...
  return listofData.map<SujathaSchoolList>(SujathaSchoolList.fromJson).toList();
}
